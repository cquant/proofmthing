...
myControllers.controller('MainCtrl', ['$scope', '$rootScope', '$window', '$location', 'navSvc', function ($scope, $rootScope, $window, $location, navSvc) {
        ...
        $scope.toggleMenu = function(){
            devLog('controllers.MainCtrl.toggleMenu START');
            $scope.showmenu=($scope.showmenu) ? false : true;
        }

        $scope.menuGo = function( path ) {
            devLog('controllers.MainCtrl.menuGo START path('+path+')');
            ...
            switch (path) {
                ...
                case "viewNotification":
                    ...
                    break;
                case "viewGeolocation":
                    $scope.headerTitle = "- Geolocation";
                    break;
                case "viewAcceleration":
                    $scope.headerTitle = "- Acceleration";
                    break;
                case "viewDevice":
                    $scope.headerTitle = "- Device";
                    break;
                case "viewCamera":
                    $scope.headerTitle = "- Camera";
                    break;
                case "viewContacts":
                    $scope.headerTitle = "- Contacts";
                    break;
                case "viewCompass":
                    $scope.headerTitle = "- Compass";
                    break;
                default:
                    $scope.headerTitle = "";
                    break;
            }
            devLog('controllers.MainCtrl $scope.headerTitle...'+$scope.headerTitle);
        ...
        $rootScope.naviGo = function(path) {
          devLog('controllers.MainCtrl $rootScope.naviGo $scope.slide(slide-left) path('+path+')');
          $scope.slide = 'slide-left';
          //$scope.headerShowBack = true;
          $location.url(path);
        }

        $scope.slidePage = function (path, type) {
            devLog('controllers.MainCtrl.slidePage START path('+path+') type('+type+')');
            navSvc.slidePage(path,type);
        };
    /*
        $scope.back = function () {
            devLog('controllers.MainCtrl.back START');
            navSvc.back();
        };
     */
    }]);
